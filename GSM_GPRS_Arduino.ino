...
void SendTextMessage()
{
  ...
  delay(1000);
  mySerial.println("AT + CMGS = \"+88019********\"\r");//send sms message, be careful need to add a country code before the cellphone number
  delay(1000);
...
void DialVoiceCall()
{
  mySerial.println("ATD + +88019********;");//dial the number
  delay(100);
  mySerial.println();
}
